...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRINCE-MDX~H4Tik8y23ji3ZAOiwJ2j", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "256784391777", // Only 1 owner Number Here, others Add to sudo numbers...
